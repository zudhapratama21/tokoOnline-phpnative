...
<section class="konten"> 
	<div class="container" style="margin-top: 40px;margin-bottom:350px;">

		<h1 style="color:#04B79E;"><i class="fas fa-shopping-cart"></i> Keranjang Belanja</h1>
		<hr>
		<table class="table table-bordered">
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<a class="btn btn-danger btn-xs" href="hapuskeranjang.php?id=<?php echo $id_produk ?>"> <i class="fas fa-trash-restore"></i> Hapus</a>
					</td> 				
				</tr>
				<?php $nomor++; ?>
				<?php endforeach ?>
		...
		<a href="index.php" class="btn btn-primary"><i class="fas fa-arrow-circle-left"></i> Lanjutkan Belanja</a>
		<a href="checkout.php" class="btn btn-danger"><i class="fas fa-tags"></i> Checkout</a>
