...
if (empty($detbay)) {
    echo "<script>alert('anda belum membayar pesanan')</script>";
    echo "<script>location='riwayat.php'</script>";
    exit();
  }
  //jika data yang bayar tidak sesuai dengan yang login
...
<div class="container" style="margin-bottom: 350px;margin-top: 30px;">
    <h3 style="color:#04B79E "><b><i class="fas fa-user-tag"></i> Lihat pembayaran</b></h3>
    <div class="row">
      <div class="col-md-6">
          <table class="table">
            <tr>
            ...
            <tr>
              <th>Status Barang</th>
              <td><?php $detbay['status_pembelian']; ?></td>

            </tr>
          </table>
      </div>
      <div class="col-md-6">
        <img src="bukti pembayaran/<?php echo $detbay['bukti'];?>" style="width: 200px;height: 200px;">
      </div>
    </div>
    <a href="riwayat.php" class="btn btn-success" style="border-radius: 17px;"><i class="fas fa-arrow-circle-left"></i> Kembali ke riwayat</a>
</div>
